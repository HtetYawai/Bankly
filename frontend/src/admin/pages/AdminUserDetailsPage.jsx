...
import { ArrowLeft, Ban, CheckCircle2, KeyRound, Snowflake, UserRound, WalletCards } from "lucide-react";
...
function Field({ label, value }) {
  return <div><dt className="text-xs font-medium uppercase tracking-wide text-slate-400">{label}</dt><dd className="mt-1 break-words text-sm font-medium text-slate-800">{value || "—"}</dd></div>;
}
